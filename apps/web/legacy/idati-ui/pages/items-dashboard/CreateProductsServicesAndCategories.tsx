		...
		if (productCategoryTab === "CATEGORY") {
			...
			if (isBulkUpload) {
				...
				if (productServiceBody?.type === "SERVICE") {
					...
					if (res) {
						setProductServiceBody(initBody);
					}
								...
								<div className="divide-y divide-gray-200 -my-7">
									<div className="py-7">
										...
										<div className="grid grid-cols-1 mt-6 sm:grid-cols-2 gap-y-5 gap-x-6">
											{isBulkUpload ? (
												<BulkUploadInput templateName={templateName} />
											) : (
												<>
													{" "}
															...
															<div className=" col-span-1  ">
																...
																<div className="mt-0">
																	<ServiceCycleSelect
																		onChange={handleChange}
																		value={
																			productServiceBody?.serviceCycle
																				?.duration || ""
																		}
																	/>
																</div>
															...
															<div className=" col-span-1  ">
																...
																<div className="mt-0">
																	<BillingCycleSelect
																		onChange={handleChange}
																		value={
																			productServiceBody?.billingCycle
																				?.duration || ""
																		}
																	/>
																</div>
