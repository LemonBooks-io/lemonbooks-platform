...
export default function ClientSelector({ description = "Select Client" }) {
	...
	function swapClientId(newId) {
		const newPath = path.replace(/(\/clients\/)([^/]+)/, `$1${newId}`);
		navigate(newPath);
	}
