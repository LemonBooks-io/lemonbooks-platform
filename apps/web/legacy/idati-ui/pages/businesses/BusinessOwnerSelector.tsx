...
export default function BusinessOwnerSelector({
					...
					<div className="relative">
						<div className="mt-2">
							<div
								...
								className="cursor-pointer flex  w-[500px]  py-3 px-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm"
							>
