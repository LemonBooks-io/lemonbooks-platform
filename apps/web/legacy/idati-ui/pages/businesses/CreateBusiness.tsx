...
import ClientSelectorMain from "../invoices-estimate-dashboard/ClientSelectorMain";
	...
	return (
		<>
			<section className="py-12  bg-white sm:py-16 lg:py-20">
				<div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl pb-6">
						...
						>
							<div className=" flex justify-end   ">
								<BusinessOwnerSelector
									description={`Select the client you want to create a business account for`}
								/>
							</div>
						</div>
					</div>
									...
									<div className="divide-y divide-gray-200 -my-7">
										<div className="py-7">
											<h2 className="text-base font-bold text-gray-900">
												Business Details (Billing Portal)
											</h2>
											...
											<div className="grid grid-cols-1 mt-6 sm:grid-cols-2 gap-y-5 gap-x-6">
												...
												<div className="col-span-3 ">
													<Button
														isLoading={isLoading}
														message={`Creating Billing Services Account...`}
														onClick={createClientHandler}
													>
														Create Business (Billing Services) Account Now
													</Button>
												</div>
											</div>
										</div>
