...
import { postMulti } from "../../utils/fetch-function";
...
export default function PaymentMethodSelector({
	...
	const paymentOptions = [
		{ id: 1, name: "Bank Transfer", value: "BANK_TRANSFER" },
		{ id: 2, name: "Cash Payment", value: "CASH" },
		{ id: 3, name: "Check Payment", value: "CHEQUE" },
		{ id: 4, name: "Link Payment", value: "LINK" },
	];
							...
							>
								<div className="flex justify-between items-center">
									<div className="flex items-center space-x-2">
										...
										<span>
											{selectedPayment ? selectedPayment?.name : description}
										</span>
									</div>
									<svg
